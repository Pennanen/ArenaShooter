...
*/
if (obj_player.playerTeam = 1){
draw_sprite_ext(spr_player_hp,3,ww/2,24,-8*(cp_status_1/100),4,0,c_white,1);
draw_sprite_ext(spr_player_hp,0,ww/2,24,8*(cp_status_2/100),4,0,c_white,1);
}
else if (obj_player.playerTeam = 2)
{
draw_sprite_ext(spr_player_hp,0,ww/2,24,-8*(cp_status_1/100),4,0,c_white,1);
draw_sprite_ext(spr_player_hp,3,ww/2,24,8*(cp_status_2/100),4,0,c_white,1);
}