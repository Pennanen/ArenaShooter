...
if (can_shoot && mouse_check_button(mb_left) && ammo >= 1 && !reloading)
	...
	obj_player.Vx +=lengthdir_x(0.2,obj_player.gun.image_angle-180);
	obj_player.Vy +=lengthdir_y(0.2,obj_player.gun.image_angle-180);
	...
	b1.identifier = irandom_range(0,32000);
	with(b1)
	{
	dmg = other.wpnDmg;
	type = dmg;
