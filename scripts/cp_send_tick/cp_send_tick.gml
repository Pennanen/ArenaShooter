...
buffer_write(obj_client.tick_buffer,buffer_s16,cp_status_1);
buffer_write(obj_client.tick_buffer,buffer_s16,cp_status_2);
buffer_write(obj_client.tick_buffer,buffer_s16,cp_captured);
